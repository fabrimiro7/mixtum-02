...
INSTALLED_APPS = [
    ...
    "base_modules.links",
    "base_modules.integrations.messaging",
    "plugins.plugin_example",

    # Integrations
    "base_modules.integrations.notifications",
    "base_modules.integrations.automation",
]
...
MIDDLEWARE = [
    ...
    "base_modules.workspace.middleware.WorkspaceMiddleware",
